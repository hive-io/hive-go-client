...
* [hioctl cluster disable-hivesense](hioctl_cluster_disable-hivesense.md)	 - Disable HiveSense
...
* [hioctl cluster enable-hivesense](hioctl_cluster_enable-hivesense.md)	 - Enable HiveSense
...
* [hioctl cluster members](hioctl_cluster_members.md)	 - List the members of the cluster
* [hioctl cluster reset-broker](hioctl_cluster_reset-broker.md)	 - reset broker settings to the defaults
* [hioctl cluster restart-shared-storage](hioctl_cluster_restart-shared-storage.md)	 - Restarts the hive-storage service across the cluster
...
* [hioctl cluster status](hioctl_cluster_status.md)	 - Get the status of the cluster
