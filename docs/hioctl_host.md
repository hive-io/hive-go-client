...
* [hioctl host delete-support-file](hioctl_host_delete-support-file.md)	 - delete a support file from a host
...
* [hioctl host download-support-file](hioctl_host_download-support-file.md)	 - download a support file from a host
...
* [hioctl host generate-support-file](hioctl_host_generate-support-file.md)	 - generate a support file on a host
* [hioctl host get](hioctl_host_get.md)	 - get host details
* [hioctl host get-acme-certificate](hioctl_host_get-acme-certificate.md)	 - Get the ACME certificate information from the host
* [hioctl host get-certificate](hioctl_host_get-certificate.md)	 - Get the certificate information from the host
...
* [hioctl host list-acme-certificates](hioctl_host_list-acme-certificates.md)	 - List ACME certificates on the host
* [hioctl host list-software](hioctl_host_list-software.md)	 - list available software packages on a host
* [hioctl host list-support-files](hioctl_host_list-support-files.md)	 - list support files on a host
...
* [hioctl host request-acme-certificate](hioctl_host_request-acme-certificate.md)	 - Request a certificate from an ACME server
...
* [hioctl host upload-certificate](hioctl_host_upload-certificate.md)	 - Upload a certificate to the host
